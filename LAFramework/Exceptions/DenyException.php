...
class DenyException extends \Exception implements IError {
    ...
    public function genereError() {
        ...
        if ($this->container->get('request')->isAjax()) {
            ...
            $this->container->get('response')->setHtmlResponse($this->container->get('view')->render(Config::getParam('tpl403')));
        }
